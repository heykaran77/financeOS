  ...
  return (
    <DialogPortal {...portalProps}>
      ...
      <DialogViewport
        className={cn(
          bottomStickOnMobile &&
            'max-sm:grid-rows-[1fr_auto] max-sm:p-2 max-sm:pt-12',
        )}
      >
        <DialogPrimitive.Popup
          className={cn(
            ...
            bottomStickOnMobile &&
              'max-sm:max-w-none max-sm:origin-bottom max-sm:rounded-t-2xl max-sm:rounded-b-none max-sm:border-x max-sm:border-t max-sm:border-b-0 max-sm:before:hidden max-sm:before:rounded-none max-sm:data-ending-style:translate-y-4 max-sm:data-starting-style:translate-y-4',
            className,
          )}
